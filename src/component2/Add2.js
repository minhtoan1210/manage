            ...
            <div style={{ width: '310px', position: 'absolute', right: "-114px", top: "93px", zIndex: "10" }}>
              <div className="card-body" >
                ...
                <div className="form-group">
                  <input defaultValue={this.props.dlsua3.name} onChange={(even) => this.getsuadl(even)} type="text" className="form-control" placeholder="Mã Phòng" name="name" />
                </div>
                <div className="form-group">
                  <input defaultValue={this.props.dlsua3.tel} onChange={(even) => this.getsuadl(even)} type="text" className="form-control" placeholder="Số Lượng" name="tel" />
                </div>
                <div className="form-group">
